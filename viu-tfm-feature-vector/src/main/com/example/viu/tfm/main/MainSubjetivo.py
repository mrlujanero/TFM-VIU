...
if __name__ == "__main__":
    ...
    lectorTraining.createSetEtiquetas(tra_label_dir, '"true"')
    ...
    featuresWritter.writeFeatures(lectorTraining.tweets, "subjective_training.arff", "subjective_ngrams.csv")